...
describe('Ticket e2e test', () => {
  ...
  const ticketSample = { title: 'regarding' };
  ...
  describe('new Ticket page', () => {
    ...
    it('should create an instance of Ticket', () => {
      ...
      cy.get(`[data-cy="description"]`).type('than drain whenever');
      cy.get(`[data-cy="description"]`).should('have.value', 'than drain whenever');

      cy.get(`[data-cy="dueDate"]`).type('2025-12-02');
      cy.get(`[data-cy="dueDate"]`).blur();
      cy.get(`[data-cy="dueDate"]`).should('have.value', '2025-12-02');

      cy.get(`[data-cy="date"]`).type('2025-12-02T01:31');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2025-12-02T01:31');
