...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '3810df33-bbbb-453b-ba0a-1411728350ae' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('0367829c-35a0-420d-8ef3-555975147318');
      cy.get(`[data-cy="name"]`).should('have.value', '0367829c-35a0-420d-8ef3-555975147318');
