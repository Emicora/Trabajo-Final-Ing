...
describe('Comment e2e test', () => {
  ...
  describe('new Comment page', () => {
    ...
    it('should create an instance of Comment', () => {
      cy.get(`[data-cy="date"]`).type('2025-12-01T15:24');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2025-12-01T15:24');

      cy.get(`[data-cy="text"]`).type('pfft');
      cy.get(`[data-cy="text"]`).should('have.value', 'pfft');
