...
import static com.bugtracker.domain.TicketAsserts.*;
import static com.bugtracker.web.rest.TestUtil.createUpdateProxyForBean;
import static com.bugtracker.web.rest.TestUtil.sameInstant;
...
import com.bugtracker.domain.Ticket;
...
class TicketResourceIT {
    ...
    void partialUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.description(UPDATED_DESCRIPTION).dueDate(UPDATED_DUE_DATE).date(UPDATED_DATE).type(UPDATED_TYPE);
